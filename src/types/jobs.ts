...
// ─── CONFIGURAÇÕES VISUAIS POR ENUM ──────────────────────────────────────────
const FORMAT_CFG = {
...
// Cor determinística baseada no nome (mesma empresa → mesma cor sempre)
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: 'transparent' }}>
        ...
        <View style={{ flex: 1, backgroundColor: C.bg }}>
          ...
          >
            ...
            ════════════════════════════════════════════════════════════════ */}
            <View style={sk.hero}>
              {/* Gradiente laranja no canto direito */}
            ...
            <Animated.View style={{ opacity: contentO, transform: [{ translateY: contentY }] }}>
              ...
              {/* ── INFOS RÁPIDAS — pills em grade 2 colunas ─────────────── */}
